...
#define GET_DECODER_SURFACE 0 && DECODER_SURFACE
...
#if !DIRECT_DXVA || EXTRACT_LOCKS || GET_DECODER_SURFACE || !DECODER_SURFACE
    D3DLOCKED_RECT lock;
...
#if DIRECT_DXVA
#if EXTRACT_LOCKS || GET_DECODER_SURFACE || !DECODER_SURFACE
    picture->p_sys = p_picture_sys;
#else
