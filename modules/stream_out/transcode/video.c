...
int transcode_video_new( sout_stream_t *p_stream, sout_stream_id_sys_t *id )
{
    ...
    id->p_encoder->fmt_in.video.i_visible_width  = id->p_encoder->fmt_in.video.i_visible_width & ~1;
    id->p_encoder->fmt_in.video.i_visible_height = id->p_encoder->fmt_in.video.i_visible_height & ~1;
